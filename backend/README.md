...
### Dois bugs reais do `html-to-docx` 1.8.0 (e o fix aplicado)

A barra de ferramentas da tela de Contratos ganhou itálico, sublinhado, lista com marcadores e alinhamento de texto. Testando a exportação pra `.docx` desses formatos (gerando `.docx` reais e inspecionando o XML gerado — não é suposição), dois bugs reais foram encontrados na lib `html-to-docx` 1.8.0, lendo o código-fonte dela pra confirmar a causa:
